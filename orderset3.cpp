// This a program to demonstrate insert in a binary tree through recursion it also keeps count of all child of a node
...
int Kpify(tree *curr, int pos, int target){
    ...
    //in this we are checking whether the required index is lesser than the no. of child in the left, then we go to left side
    if( curr -> left != NULL){
